...
import styles from './ProfilePagination.module.scss';
...
const data = Array.from({ length: 100 }, (_, i) => `Элемент ${i + 1}`); //Массив данных

export const ProfilePagination: React.FC<Props> = ({ itemsPerPage }) => {
