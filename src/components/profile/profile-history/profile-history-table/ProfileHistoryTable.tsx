...
import styles from './ProfileHistoryTable.module.scss';
import { ProfileHistoryTableItem } from './profile-history-table-item.tsx/ProfileHistoryTableItem';
...
export const ProfileHistoryTable: React.FC<Props> = ({
	className,
	itemsPerPage,
}) => {
				...
				<tbody className='flex flex-col gap-1'>
					{data ? (
						data
							...
							.map((item, index) => (
								<ProfileHistoryTableItem key={index} data={item} />
							))
					) : (
						<></>
					)}
