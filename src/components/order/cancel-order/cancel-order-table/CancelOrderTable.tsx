...
import styles from './CancelOrderTable.module.scss';
import { CancelOrderTableItem } from './cancel-order-table-item/CancelOrderTableItem';
...
export const CancelOrderTable: React.FC<Props> = ({
	className,
	itemsPerPage,
}) => {
